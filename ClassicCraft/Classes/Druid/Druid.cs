...
namespace ClassicCraft
{
    class Druid : Player
    {
        ...
        public Druid(Simulation s = null, Races r = Races.Orc, int level = 60, Dictionary<Slot, Item> items = null, Dictionary<string, int> talents = null, List<Enchantment> buffs = null, bool tanking = false, bool facing = false, List<string> cooldowns = null)
            : base(s, Classes.Druid, r, level, items, talents, buffs, tanking, facing, cooldowns)
        {
        }
