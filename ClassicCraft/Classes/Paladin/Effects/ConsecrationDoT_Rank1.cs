...
{
    class ConsecrationDoT_Rank1 : EffectOnTime
    {
        public override string ToString() { return NAME; }
        public static new string NAME = "Consecration (Rank 1) DoT";

        public static double DURATION = 7;
        public static double RATIO = 0.33;
        public static int NB_TICKS = (int)DURATION;

        public static double DMG = 64;

        public ConsecrationDoT_Rank1(Player p, Entity target)
