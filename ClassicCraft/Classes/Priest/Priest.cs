...
namespace ClassicCraft
{
    class Priest : Player
    {
        ...
        public Priest(Simulation s = null, Races r = Races.Undead, int level = 60, Dictionary<Slot, Item> items = null, Dictionary<string, int> talents = null, List<Enchantment> buffs = null, bool tanking = false)
            : base(s, Classes.Priest, r, level, items, talents, buffs, tanking)
        {
        }
